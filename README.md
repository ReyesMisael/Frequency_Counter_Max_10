...
combination of VHDL, Altera IP catalog, and Block diagram code to interconect all modules. this project is in continuos 
develomptent and this are a beta verstion, the next step is a full VHDL/verilog code implementatios that can be run in most FPGA devices 
